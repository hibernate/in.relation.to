...
Ståle Pedersen
:awestruct-tags: [ "Hibernate ORM", "Performance", "JSON" ]
...
1. *Deep-copies* the JSON value by serializing it to a string and deserializing it back (`FormatMapperBasedJavaType.deepCopy`) -- this creates the snapshot
...
[cols="3,1", stripes="even", options="header"]
|===
| Allocator | Bytes
...
[cols="2,1,1,1"], stripes="even", options="header"]
|===
...
[cols="2,1,1,1,1", stripes="even", options="header"]
|===
