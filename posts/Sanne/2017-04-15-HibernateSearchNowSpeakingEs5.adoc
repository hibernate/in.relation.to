...
If you can't wait, we won't prevent you from peeking into the https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#_simple_query_string_queries[Simple Query String documentation].
...
See also the http://docs.hibernate.org/orm/5.2/userguide/html_single/Hibernate_User_Guide.html#jndi[JNDI configuration in the Hibernate ORM documentation].
