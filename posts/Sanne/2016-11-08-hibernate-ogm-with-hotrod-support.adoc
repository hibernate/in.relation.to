...
You can find many more interesting details in our https://docs.hibernate.org/ogm/5.1/reference/en-US/html/ch09.html[Infinispan integration reference guide]; I've included a section to help you choose between Infinispan Embedded
