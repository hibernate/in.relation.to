...
See also the http://docs.hibernate.org/search/5.4/reference/en-US/html_single/#search-architecture-jms[JMS Architecture documentation]
and the http://docs.hibernate.org/search/5.4/reference/en-US/html_single/#jms-backend[JMS slave nodes configuration properties].
