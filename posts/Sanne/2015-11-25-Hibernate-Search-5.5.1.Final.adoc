...
See also http://docs.hibernate.org/search/5.5/reference/en-US/html_single/#sortablefield-annotation[Example 4.5. Marking fields as sortable via a custom field bridge]
