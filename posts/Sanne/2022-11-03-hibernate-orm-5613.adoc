...
An https://hibernate.atlassian.net/browse/HHH-15634[important issue] was identified: when enabling bytecode enhancement and applying this to https://docs.hibernate.org/orm/current/userguide/html_single/Hibernate_User_Guide.html#BytecodeEnhancement-lazy-loading[lazy loaded properties],
