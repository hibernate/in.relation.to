= Hibernate Search 8.2.0.Final is out
Marko Bekhta
...
:hsearch-jira-version-id: 36773
---

We are excited to announce the release of Hibernate Search 8.2.0.Final.

Compared to the 8.1 series, 8.2 brings compatibility with the latest Hibernate ORM 7.2,
Elasticsearch 9.2 and OpenSearch 3.2/3.3.
It also introduces the pluggable Elasticsearch backend clients.

Compared to the previously released 8.2.0.CR1, this version is almost identical,
and only adds a few changes to adapt to the newly released Hibernate ORM 7.2.0.Final.

== What's new since 8.1

=== Dependency upgrades

[[orm-version]]
Hibernate ORM (link:{hsearch-jira-url-prefix}/HSEARCH-5541[HSEARCH-5541])::
...
[[others-version]]
Others::
* link:{hsearch-jira-url-prefix}/HSEARCH-5538[HSEARCH-5538]: Upgrade to Elasticsearch **client** 9.2.2 (`elasticsearch-rest-client`)
* link:{hsearch-jira-url-prefix}/HSEARCH-5536[HSEARCH-5536]: Upgrade to Elasticsearch **client** 9.2.2 (`elasticsearch-rest5-client`)
* link:{hsearch-jira-url-prefix}/HSEARCH-5524[HSEARCH-5524]: Upgrade to OpenSearch **client** 3.3.2 (`opensearch-rest-client`)
* link:{hsearch-jira-url-prefix}/HSEARCH-5540[HSEARCH-5540]: Upgrade to AWS SDK 2.40.4
