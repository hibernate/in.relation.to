= Hibernate Search 8.1.0.Alpha1 is out
Marko Bekhta
...
:hsearch-jira-version-id: 33869
---

We just published Hibernate Search 8.1.0.Alpha1,
...
[NOTE]
====
Hibernate Search 8.1 is still in its early stages of development:
...
[[orm-version]]
Hibernate ORM (link:{hsearch-jira-url-prefix}/HSEARCH-5433[HSEARCH-5433])::
...
[[others-version]]
Others::
* link:{hsearch-jira-url-prefix}/HSEARCH-5427[HSEARCH-5427]: Upgrade to Elasticsearch **client** 9.0.4
