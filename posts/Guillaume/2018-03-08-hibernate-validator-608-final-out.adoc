...
You can find all the information related to this new feature in https://docs.hibernate.org/stable/validator/reference/en-US/html_single/#constraint-validator-payload[our reference documentation].
