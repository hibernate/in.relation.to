 ...
 * We added automatic module names for the new Java 9 module system. You can find them in http://docs.hibernate.org/validator/6.0/reference/en-US/html_single/#validator-gettingstarted-java9[our reference documentation].
