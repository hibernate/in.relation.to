...
$(function() {
	...
	Plotly.newPlot('simple-validation-jmh-chart', data, layout);
	...
	Plotly.newPlot('cascaded-validation-jmh-chart', data, layout);
	...
	Plotly.newPlot('bean-validation-benchmark-chart', data, layout);
});
</script>
++++
