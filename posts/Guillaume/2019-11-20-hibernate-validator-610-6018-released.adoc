...
The new contract is called `PropertyNodeNameProvider` and you can find out more about it in https://docs.hibernate.org/stable/validator/reference/en-US/html_single/#section-property-node-name-provider[our documentation].
