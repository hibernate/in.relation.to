= "Hibernate Validator 6.0.15.Final released"
Guillaume Smet
:awestruct-tags: [ "Hibernate Validator", "Releases" ]
:awestruct-layout: blog-post
:released-version: 6.0.15.Final
---
...
We fixed one important issue related to the usage of `@GroupSequence`: https://hibernate.atlassian.net/browse/HV-1692[HV-1692].
