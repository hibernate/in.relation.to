...
And, finally, we added support for these new constraints to the http://docs.hibernate.org/validator/6.0/reference/en-US/html_single/#validator-annotation-processor[annotation processor].
