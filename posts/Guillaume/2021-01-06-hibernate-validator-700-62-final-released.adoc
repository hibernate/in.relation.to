...
* https://docs.hibernate.org/validator/6.2/reference/en-US/html_single/#section-interpolation-with-message-expressions[General overview]
* https://docs.hibernate.org/validator/6.2/reference/en-US/html_single/#el-features[Bootstrapping a `ValidatorFactory` with a specific Expression Language feature level]
* https://docs.hibernate.org/validator/6.2/reference/en-US/html_single/#section-hibernateconstraintvalidatorcontext[Creating custom violations supporting EL with `HibernateConstraintValidatorContext`]

While absolutely not recommended, you can go back to the previous behavior without changing your code by using https://docs.hibernate.org/validator/6.2/reference/en-US/html_single/#el-features[the two properties described at the end of this paragraph of our documentation].
