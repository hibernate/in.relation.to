...
See http://docs.hibernate.org/orm/5.4/userguide/html_single/Hibernate_User_Guide.html#fetching-strategies-dynamic-fetching-entity-graph[the documentation] for in-depth discussion and examples.
