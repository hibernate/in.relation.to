...
See https://docs.hibernate.org/stable/validator/reference/en-US/html_single/#section-clock-provider[our reference documentation] for more information about this new feature.
