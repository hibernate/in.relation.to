 ...
 * Marko Bekhta finished his work on the http://docs.hibernate.org/validator/5.4/reference/en-US/html_single/#validator-annotation-processor[annotation processor]: we are now on a par with the Hibernate Validator engine features
