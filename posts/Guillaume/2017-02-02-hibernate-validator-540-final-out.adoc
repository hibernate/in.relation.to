...
So our https://docs.hibernate.org/stable/validator/reference/en-US/html_single/[reference documentation] now uses a nice AsciiDoctor output and so does our https://docs.hibernate.org/stable/validator/reference/en-US/pdf/hibernate_validator_reference.pdf[PDF documentation].
