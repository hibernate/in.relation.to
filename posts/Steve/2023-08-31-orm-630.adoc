...
:major-minor: 6.3
:docs-url: https://docs.hibernate.org/orm/{major-minor}
...
Hibernate's https://docs.hibernate.org/orm/6.3/userguide/html_single/Hibernate_User_Guide.html#fetching-fetchmode-subselect[SUBSELECT]
fetching style can now be applied dynamically using https://docs.hibernate.org/orm/6.3/introduction/html_single/Hibernate_Introduction.html#fetch-profiles[fetch profiles].  E.g.
