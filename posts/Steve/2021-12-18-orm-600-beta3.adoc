...
See the https://docs.hibernate.org/orm/6.0/userguide/html_single/Hibernate_User_Guide.html#multitenacy9User Guide]
...
models.  See the
link:https://docs.hibernate.org/orm/6.0/userguide/html_single/Hibernate_User_Guide.html#domain-customizing[User Guide]
...
See the https://docs.hibernate.org/orm/6.0/userguide/html_single/Hibernate_User_Guide.html[user guide] and
