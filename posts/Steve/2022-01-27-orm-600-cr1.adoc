...
See the
https://docs.hibernate.org/orm/6.0/userguide/html_single/Hibernate_User_Guide.html#collection-type-ann[User Guide]
for details
...
The https://docs.hibernate.org/orm/6.0/userguide/html_single/Hibernate_User_Guide.html[User Guide]
