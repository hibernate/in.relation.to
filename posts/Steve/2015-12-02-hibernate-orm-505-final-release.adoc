...
The complete list of changes can be found http://hibernate.atlassian.net/projects/HHH/versions/21750[here] (or https://hibernate.atlassian.net/issues/?jql=project=10031%20AND%20fixVersion=21850[here] for people without a Hibernate Jira account).
