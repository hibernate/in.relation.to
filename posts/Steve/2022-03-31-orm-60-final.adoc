...
link:{user-guide-url}#basic[User Guide] contains
the details.

The mapping of embeddables has also changed.  Again, see the
link:{user-guide-url}#embeddable[User Guide] for
details.  Embeddables now support
link:{user-guide-url}#embeddable-instantiator[constructor injection]
