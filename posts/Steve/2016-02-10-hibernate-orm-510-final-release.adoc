...
The complete list of changes can be found https://hibernate.atlassian.net/projects/HHH/versions/19355[here] (or https://hibernate.atlassian.net/issues/?jql=project=10031+AND+fixVersion=19355[here] for people without a Hibernate Jira account).
