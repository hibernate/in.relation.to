...
- Speaking of which, I https://docs.jboss.org/hibernate/orm/7.0/migration-guide/migration-guide.html#load-fetch-graphs[completely re-engineered] the package `org.hibernate.graph`.
