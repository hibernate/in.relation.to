...
- a stateless session can now https://docs.hibernate.org/orm/7.0/whats-new/whats-new.html#stateless-session-cache[read and write data to and from the second-level cache], and
- has an https://docs.hibernate.org/orm/7.0/whats-new/whats-new.html#stateless-session-multiple[improved API for dealing with batching].
...
What makes this new API truly powerful that it can be used to https://docs.hibernate.org/orm/7.0/introduction/html_single/Hibernate_Introduction.html#restrictions-and-ordering[add restrictions or ordering] to an existing "base" query written in HQL:
...
A https://docs.hibernate.org/orm/7.0/javadocs/org/hibernate/query/restriction/Restriction.html[`Restriction`] packages a reference to an element of the static metamodel with a https://docs.hibernate.org/orm/7.0/javadocs/org/hibernate/query/range/Range.html[`Range`] of allowed values.

`Restriction` and `Range` may even be used in https://docs.hibernate.org/orm/7.0/repositories/html_single/Hibernate_Data_Repositories.html#dynamic-restrictions[Hibernate Data Repositories].
...
A full list of new features may be found in https://docs.hibernate.org/orm/7.0/whats-new/whats-new.html[What's New], and more information about changes which affect existing programs may be found in the https://docs.hibernate.org/orm/7.0/migration-guide/migration-guide.html[Migration Guide].
I will therefore limit myself to mentioning just a few more new features here:

- We've finally yielded to years of begging and nagging from our user community, and introduced https://docs.hibernate.org/orm/7.0/whats-new/whats-new.html#embedded-column-naming[a way to specify a common prefix or suffix] for the columns mapped by an `@Embeddable` type.

- Steve has created a https://docs.hibernate.org/orm/7.0/whats-new/whats-new.html#NamedEntityGraph[simple mini-language] making it incredibly easy to define a named `EntityGraph`.

- Speaking of which, I https://docs.hibernate.org/orm/7.0/migration-guide/migration-guide.html#load-fetch-graphs[completely re-engineered] the package `org.hibernate.graph`.

- Christian added new functions for https://docs.hibernate.org/orm/7.0/whats-new/whats-new.html#json-xml-functions[working with JSON and XML], and for https://docs.hibernate.org/orm/7.0/whats-new/whats-new.html#set-returning-functions[returning sets].

- It's easy to miss the new features of the JPA Criteria API, including https://jakarta.ee/specifications/persistence/3.2/apidocs/jakarta.persistence/jakarta/persistence/criteria/criteriabuilder#union(jakarta.persistence.criteria.CriteriaSelect,jakarta.persistence.criteria.CriteriaSelect)[`union()`], `intersect()`, and `except()`, joins on entity type, along with https://jakarta.ee/specifications/persistence/3.2/apidocs/jakarta.persistence/jakarta/persistence/criteria/expression#cast(java.lang.Class)[`cast()`], https://jakarta.ee/specifications/persistence/3.2/apidocs/jakarta.persistence/jakarta/persistence/criteria/criteriabuilder#extract(jakarta.persistence.criteria.TemporalField,jakarta.persistence.criteria.Expression)[`extract()`], `left()` `right()`, and https://jakarta.ee/specifications/persistence/3.2/apidocs/jakarta.persistence/jakarta/persistence/criteria/criteriabuilder#replace(jakarta.persistence.criteria.Expression,java.lang.String,java.lang.String)[`replace()`].

== A Short Guide to Hibernate 7

Finally, https://docs.hibernate.org/orm/7.0/introduction/html_single/Hibernate_Introduction.html[_A Short Guide to Hibernate 7_] is a substantially-rewritten new edition of _An Introduction to Hibernate 6_.
