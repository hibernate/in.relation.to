...
I'm not sure if this is a topic I really want to talk about in the https://docs.hibernate.org/orm/6.6/introduction/html_single/Hibernate_Introduction.html[documentation], but it's definitely worth a blog.
