...
* Extension of the
  link:http://docs.hibernate.org/beanvalidation/spec/1.1/api/javax/validation/Path.html[Path API]
  for nodes of type `ElementKind.PROPERTY`, which allows to obtain the value
  of the represented property.
  link:http://docs.hibernate.org/validator/5.2/reference/en-US/html_single/#section-extensions-path-api[read more...]

* TimeProvider contract. link:http://docs.hibernate.org/validator/5.2/reference/en-US/html_single/#section-time-provider[read more...]
