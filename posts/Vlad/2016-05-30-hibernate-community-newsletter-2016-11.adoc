...
* I wrote a short guide about https://vladmihalcea.com/how-to-call-postgresql-functions-from-hibernate/[calling PostgreSQL stored procedures and functions from Hibernate].
