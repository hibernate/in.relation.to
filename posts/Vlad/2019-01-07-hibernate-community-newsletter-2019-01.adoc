...
If we plan on using Spring Boot with Hibernate, http://sinhamohit.com/writing/spring-boot-hibernate-tips[this article] shows you how to get started and set up the project in very simple steps.
