...
* If you want to speed up your data access layer performance, don't miss the https://vladmihalcea.com/14-high-performance-java-persistence-tips/[14 Hibernate Performance Tuning Tips] article.
...
* I wrote an article about how you can https://vladmihalcea.com/how-to-lazy-load-entity-properties-with-hibernate/[lazy load entity properties with Hibernate].
