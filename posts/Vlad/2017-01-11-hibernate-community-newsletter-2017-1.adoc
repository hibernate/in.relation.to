...
For out Portuguese readers, Daniel Dias wrote an article about https://danieldiasjava.wordpress.com/2016/12/11/persistindo-dados-com-hibernate-ogm/[how you can persist data into a NoSQL database using Hibernate OGM].
