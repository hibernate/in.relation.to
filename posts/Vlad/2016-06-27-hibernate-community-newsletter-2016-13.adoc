...
* I wrote an article about how you can https://vladmihalcea.com/how-to-map-json-objects-using-generic-hibernate-types/[map any JSON object using Hibernate `Types`].
This is a generic solution that works on both PostgreSQL or MySQL.
* Because Hibernate is very customizable, there is an example of https://vladmihalcea.com/how-to-implement-a-custom-string-based-sequence-identifier-generator-with-hibernate/[how you can generate unique `String` sequences].
