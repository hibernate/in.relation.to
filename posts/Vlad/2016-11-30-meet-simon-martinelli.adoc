...
Hibernate has the https://docs.hibernate.org/orm/5.2/javadocs/org/hibernate/transform/ResultTransformer.html[`ResultTransformer`], but this only works with Hibernate.
