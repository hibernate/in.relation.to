...
Check out
https://vladmihalcea.com/how-to-join-unrelated-entities-with-jpa-and-hibernate/[this article] for more details.
...
https://vladmihalcea.com/how-does-hibernate-handle-jpa-criteria-api-literals/[handling literals when executing Criteria API queries].
...
https://vladmihalcea.com/9-high-performance-tips-when-using-mysql-with-jpa-and-hibernate/[these 9 High-Performance Tips]
