...
as explained in https://vladmihalcea.com/how-to-customize-an-entity-association-join-on-clause-with-hibernate-joinformula/[this article].
...
and https://vladmihalcea.com/the-performance-penalty-of-class-forname-when-parsing-jpql-and-criteria-queries/[the fix will be available starting from Hibernate ORM 5.2.6].
...
https://vladmihalcea.com/a-beginners-guide-to-sql-injection-and-how-you-should-prevent-it/[SQL injection attacks are real],
