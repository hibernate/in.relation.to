...
https://hibernate.atlassian.net/secure/ReleaseNote.jspa?version=31691&styleName=Html&projectId=10031[release notes].
...
https://hibernate.atlassian.net/secure/ReleaseNote.jspa?projectId=10061&version=31717[release notes].
