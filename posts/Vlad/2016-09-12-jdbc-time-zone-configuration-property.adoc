...
To answer this question, we have to first check how Hibernate saves the underlying timestamp value inside Hibernate 5.2.2 https://docs.hibernate.org/orm/5.2/javadocs/org/hibernate/type/descriptor/sql/TimestampTypeDescriptor.html[`TimestampTypeDescriptor`]:
