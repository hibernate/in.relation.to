...
* In case you want to call an Oracle stored procedure or a function, I wrote https://vladmihalcea.com/how-to-call-oracle-stored-procedures-and-functions-from-hibernate/[a guide] about how you can do it from Hibernate.
