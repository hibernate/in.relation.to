...
That's exactly what JPA and Hibernate and the application developer can focus on https://vladmihalcea.com/2014/07/30/a-beginners-guide-to-jpahibernate-entity-state-transitions/[entity state transitions] instead.
