...
We are glad to announce that the new http://docs.hibernate.org/orm/5.1/userguide/html_single/Hibernate_User_Guide.html[Hibernate ORM User Guide] has become the default Hibernate 5.1 reference documentation.
