...
If you want to learn what is the best way to handle the infamous `LazyInitializationException`, check out https://vladmihalcea.com/the-best-way-to-handle-the-lazyinitializationexception/[this article].
...
Hibernate offers a very various ways to load entity attributes lazily. Check out https://vladmihalcea.com/the-best-way-to-lazy-load-entity-attributes-using-jpa-and-hibernate/[this article for more details].
...
I also wrote an article about https://vladmihalcea.com/how-to-implement-a-custom-basic-type-using-hibernate-usertype/[implementing custom basic types using the legacy `UserType` mechanism].
