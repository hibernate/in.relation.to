...
For out Russian-speaking readers, Николай Алименков has written a very good post about http://xpinjection.com/articles/hibernate-ruined-your-project-no-it-was-you/[Hibernate usage scenarios].
