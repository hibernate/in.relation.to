...
+
I really like the fact that http://docs.hibernate.org/orm/5.2/userguide/html_single/Hibernate_User_Guide.html#spatial[Hibernate Spatial] find its way into ORM itself.
