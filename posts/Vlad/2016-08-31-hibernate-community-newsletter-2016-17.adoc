...
http://in.relation.to/2016/08/12/hibernate-orm-511-final-release/[Hibernate 5.1 has got a new release]. Check out https://hibernate.atlassian.net/issues/?jql=project=10031%20AND%20fixVersion=22550[the impressive amount of bug fixes].
