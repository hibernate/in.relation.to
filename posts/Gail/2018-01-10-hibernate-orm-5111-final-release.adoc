= Hibernate ORM 5.1.11.Final released
Gail Badner
...
* changes are listed https://hibernate.atlassian.net/projects/HHH/versions/31001[here] (or, for people without a Hibernate Jira account, https://hibernate.atlassian.net/issues/?jql=project=10031+AND+fixVersion=31001[here]);
