...
The complete list of changes can be found https://hibernate.atlassian.net/projects/HHH/versions/22250[here] (or https://hibernate.atlassian.net/issues/?jql=project=10031%20AND%20fixVersion=22250[here] for people without a Hibernate Jira account).
