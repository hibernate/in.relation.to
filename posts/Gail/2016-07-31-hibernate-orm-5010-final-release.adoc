...
The complete list of changes can be found https://hibernate.atlassian.net/projects/HHH/versions/22752[here] (or https://hibernate.atlassian.net/issues/?jql=project=10031+AND+fixVersion=22752[here] for people without a Hibernate Jira account).
