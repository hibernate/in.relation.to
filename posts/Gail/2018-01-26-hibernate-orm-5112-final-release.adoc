...
* changes are listed https://hibernate.atlassian.net/projects/HHH/versions/31629[here] (or, for people without a Hibernate Jira account, https://hibernate.atlassian.net/issues/?jql=project=10031%20AND%20fixVersion=31629[here]);
