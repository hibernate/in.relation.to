...
To learn more, take a look at the https://docs.hibernate.org/stable/validator/reference/en-US/html_single/#chapter-valueextraction[Value extraction] chapter of the Hibernate Validator reference guide.
