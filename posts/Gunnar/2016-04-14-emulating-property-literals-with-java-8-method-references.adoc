...
E.g. consider the https://docs.hibernate.org/stable/search/reference/en-US/html_single/#hsearch-mapping-programmaticapi[API for programmatic configuration] of index mappings in Hibernate Search:
