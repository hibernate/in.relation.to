...
The answer is: Yes, it is possible, http://docs.hibernate.org/orm/current/javadocs/index.html?org/hibernate/transform/ResultTransformer.html[result transformers] are the right tool for this.
