...
When migrating an existing application, be sure to *rebuild the affected index(es)* as described in the https://docs.hibernate.org/search/5.5/reference/en-US/html_single/#search-batchindex[reference guide].
