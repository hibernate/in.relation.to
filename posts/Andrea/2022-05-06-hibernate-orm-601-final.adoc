...
- The GEOGRAPHY type code has been added to `SqlTypes` to support mapping to the database native SQL type geography (see https://hibernate.atlassian.net/browse/HHH-15165[HHH-15165])
