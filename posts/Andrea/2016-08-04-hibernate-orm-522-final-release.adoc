...
The complete list of changes can be found https://hibernate.atlassian.net/projects/HHH/versions/24150/tab/release-report-done[here] (or https://hibernate.atlassian.net/issues/?jql=project=10031+AND+fixVersion=24150[here] for people without a Hibernate Jira account).
