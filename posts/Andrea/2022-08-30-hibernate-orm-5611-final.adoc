...
:docs-url: https://docs.hibernate.org/orm/5.6
...
We have fixed a bug causing an exception when trying to select the id of an association annotated with `@NotFound` (see https://hibernate.atlassian.net/browse/HHH-15425[HHH-15425] and https://docs.hibernate.org/orm/5.6/userguide/html_single/Hibernate_User_Guide.html#associations-not-found[User guide]).
