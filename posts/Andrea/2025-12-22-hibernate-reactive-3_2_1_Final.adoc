= Hibernate Reactive 3.2.1.Final released
Andrea Boriero
:awestruct-tags: [ "Hibernate Reactive", "Releases" ]
:awestruct-layout: blog-post
---

:getting-started: https://hibernate.org/reactive/releases/3.2/#getting_started
:release: https://github.com/hibernate/hibernate-reactive/releases/tag/3.2.1

{getting-started}[Hibernate Reactive 3.2.1.Final] is now available.

Hibernate Reactive 3.2.1.Final is compatible with https://github.com/hibernate/hibernate-orm/releases/tag/7.2.0[Hibernate ORM 7.2.0.Final],
and https://vertx.io/docs/4.5.23/vertx-pg-client/java/[Vert.x SQL client] 4.5.
