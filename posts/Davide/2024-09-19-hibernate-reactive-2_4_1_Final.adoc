= Hibernate Reactive 2.4.1.Final released
Davide D'Alto
...
:release: https://github.com/hibernate/hibernate-reactive/releases/tag/2.4.1

https://hibernate.org/reactive/releases/2.4/#getting_started[Hibernate Reactive 2.4.1.Final] is now available!

This release is compatible with Hibernate ORM `6.6.1.Final` and Vert.x SQL client `4.5.10`.
