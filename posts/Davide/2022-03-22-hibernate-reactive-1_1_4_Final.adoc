= Hibernate Reactive 1.1.4.Final released
Davide D'Alto
...
:milestone: https://github.com/hibernate/hibernate-reactive/milestone/23?closed=1

https://hibernate.org/reactive/releases/1.1/#getting_started[Hibernate Reactive 1.1.4.Final] is now available!
