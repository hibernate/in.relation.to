= Hibernate Reactive 4.3.0.CR1 released
Davide D'Alto
...
:release: https://github.com/hibernate/hibernate-reactive/releases/tag/4.3.0.CR1

{getting-started}[Hibernate Reactive 4.3.0.CR1] is now available.

Hibernate Reactive 4.3.0.CR1 is compatible with https://github.com/hibernate/hibernate-orm/releases/tag/7.3.0.CR2[Hibernate ORM 7.3.0.CR2],
and https://vertx.io/docs/vertx-pg-client/java/[Vert.x SQL client] 5.0.7.
