...
* provides a way to define https://docs.hibernate.org/stable/ogm/reference/en-US/html_single/#_geospatial_suppor[Geospatial indexes] for MongoDB
* additional support for https://docs.hibernate.org/stable/ogm/reference/en-US/html_single/#ogm-mongodb-cli-syntax[MongoDB CLI syntax]
