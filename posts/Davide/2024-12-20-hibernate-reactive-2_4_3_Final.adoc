...
:release: https://github.com/hibernate/hibernate-reactive/releases/tag/2.4.3

https://hibernate.org/reactive/releases/2.4/#getting_started[Hibernate Reactive 2.4.3.Final] is now available!

This release is compatible with https://github.com/hibernate/hibernate-orm/releases/tag/6.6.4.Final[Hibernate ORM 6.6.4.Final].
