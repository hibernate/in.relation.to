= Hibernate Reactive 2.4.0.Final released
Davide D'Alto
...
:release: https://github.com/hibernate/hibernate-reactive/releases/tag/2.4.0.Final

https://hibernate.org/reactive/releases/2.4/#getting_started[Hibernate Reactive 2.4.0.Final] is now available!
