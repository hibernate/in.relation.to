...
Here's an example of how you can register a server-side function (`find_cars_by_brand` in this
...
You can include the dialect in your progiect using the maven coordinates:
...
* https://github.com/wildfly/wildfly-build-tools[WildFly Feature Pack]
