...
https://docs.hibernate.org/ogm/5.4/reference/en-US/html_single/#_using_stored_procedures[using
the JPA approach].

When using the Infinispan Remote dialect it is now possible to
https://docs.hibernate.org/ogm/5.4/reference/en-US/html_single/#_caches_creation_and_configuration[configure
...
https://docs.hibernate.org/ogm/5.4/reference/en-US/html_single/#_packaging_hibernate_ogm_applications_for_wildfly_12_0[See the documentation]
