= Hibernate Reactive 2.0.3.Final released
Davide D'Alto
...
:release: https://github.com/hibernate/hibernate-reactive/releases/tag/2.0.3

https://hibernate.org/reactive/releases/2.0/#getting_started[Hibernate Reactive 2.0.3.Final] is now available!

This release add a new `getFactory()` method to the sessions API and fix a bug
https://github.com/hibernate/hibernate-reactive/issues/1504[when merging a referenced entity].
