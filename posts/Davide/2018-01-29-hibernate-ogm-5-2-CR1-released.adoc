...
https://hibernate.atlassian.net/issues/?jql=project=10160+AND+fixVersion=31605[release notes].
...
More details in the https://docs.hibernate.org/ogm/5.2/reference/en-US/html_single/#_geospatial_support[Hibernate OGM documentation].
