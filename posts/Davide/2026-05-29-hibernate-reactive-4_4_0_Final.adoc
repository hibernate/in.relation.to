= Hibernate Reactive 4.4.0.Final released
Davide D'Alto
:awestruct-tags: [ "Hibernate Reactive", "Releases" ]
:awestruct-layout: blog-post
---

:getting-started: https://hibernate.org/reactive/releases/4.4/#getting_started
:release: https://github.com/hibernate/hibernate-reactive/releases/tag/4.4.0

{getting-started}[Hibernate Reactive 4.4.0.Final] is now available.

Hibernate Reactive 4.4.0.Final is compatible with https://github.com/hibernate/hibernate-orm/releases/tag/7.4.0[Hibernate ORM 7.4.0.Final],
and https://vertx.io/docs/vertx-pg-client/java/[Vert.x SQL client] 5.0.12.
...
link:https://hibernate.org/reactive/releases/4.3/#get-it[Hibernate Reactive website releases page].
