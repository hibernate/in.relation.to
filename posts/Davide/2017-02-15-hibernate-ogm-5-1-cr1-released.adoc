...
The first candidate release for http://hibernate.org/ogm/[Hibernate OGM] 5.1 is out.
...
http://hibernate.org/search[Hibernate Search] transparently indexes your data and offers fast
