...
of a new backend: http://docs.hibernate.org/ogm/5.0/reference/en-US/html/ch01.html#how_to_build_support_for_a_data_store[How to build support for a data store]
