...
:release: https://github.com/hibernate/hibernate-reactive/releases/tag/3.0.0.Beta1

https://hibernate.org/reactive/releases/3.0/#getting_started[Hibernate Reactive 3.0.0.Beta1] is now available!

This release is compatible with https://github.com/hibernate/hibernate-orm/releases/tag/7.0.0.Beta3[Hibernate ORM 7.0.0.Beta3].
