...
We released https://hibernate.org/ogm/[Hibernate OGM] 5.1 Alpha1 and 5.0.2 Final!
...
https://docs.hibernate.org/ogm/5.1/reference/en-US/html_single/#ogm-neo4j[Neo4j section of the documentation].
