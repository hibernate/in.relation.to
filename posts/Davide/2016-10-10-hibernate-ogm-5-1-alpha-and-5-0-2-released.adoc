...
the number of calls and commands to execute on the datstore, leading to better performance.
...
and these are the back-ends currently available for 5.1.0.Alpha1:
