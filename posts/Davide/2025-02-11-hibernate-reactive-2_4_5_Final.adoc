...
:release: https://github.com/hibernate/hibernate-reactive/releases/tag/2.4.5

https://hibernate.org/reactive/releases/2.4/#getting_started[Hibernate Reactive 2.4.5.Final] is now available!

This release is compatible with https://github.com/hibernate/hibernate-orm/releases/tag/6.6.7.Final[Hibernate ORM 6.6.7.Final],
and upgrades the https://vertx.io/docs/vertx-pg-client/java/[Vert.x SQL client] to 4.5.12.Final.

It also contains a couple of bug fixes:

* https://github.com/hibernate/hibernate-reactive/issues/1904[#1904] PropertyAccessException when creating a new object with a one-to-one association
* https://github.com/hibernate/hibernate-reactive/issues/2079[#2079] Don't ignore return value of ReactiveUpdateRowsCoordinatorOneToMany#deleteRows
