...
* supports https://docs.mongodb.com/manual/aggregation/#aggregation-pipeline[aggregation]
  in MongoDB native queries with https://docs.hibernate.org/stable/ogm/reference/en-US/html_single/#ogm-mongodb-cli-syntax[CLI syntax]
...
https://docs.hibernate.org/ogm/5.1/reference/en-US/html_single/#_packaging_hibernate_ogm_applications_for_wildfly_10[4.5.1. Packaging Hibernate OGM applications for WildFly 10]
