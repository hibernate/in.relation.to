= Hibernate Reactive 2.4.2.Final released
Davide D'Alto
...
:release: https://github.com/hibernate/hibernate-reactive/releases/tag/2.4.2

https://hibernate.org/reactive/releases/2.4/#getting_started[Hibernate Reactive 2.4.2.Final] is now available!

This release contains a couple of bug fixes:

* link:https://github.com/hibernate/hibernate-reactive/issues/2004[#2004]: A `ClassCastException` when the entity uses `@IdClass`
* link:https://github.com/hibernate/hibernate-reactive/issues/1984[#1984]: JSON values weren't mapped correctly in the database
