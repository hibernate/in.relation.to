...
:milestone: https://github.com/hibernate/hibernate-reactive/milestone/27?closed=1

https://hibernate.org/reactive/releases/1.1/#getting_started[Hibernate Reactive 1.1.7.Final] is now available!

This release contains a couple of important bug fixes:
* https://github.com/hibernate/hibernate-reactive/issues/975[fix fetch many to one lazy association when using bytecode enhancements]
* https://github.com/hibernate/hibernate-reactive/issues/1342[fix error with pagination with Microsoft SQL Server]
