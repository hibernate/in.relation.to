= Hibernate Reactive 2.4.0.CR1 released
Davide D'Alto
...
:release: https://github.com/hibernate/hibernate-reactive/releases/tag/2.4.0.CR1

https://hibernate.org/reactive/releases/2.4/#getting_started[Hibernate Reactive 2.4.0.CR1] is now available!
