...
https://docs.hibernate.org/orm/6.2/migration-guide/migration-guide.html[The Hibernate ORM 6.2 migration guide] is the best place to keep up with everything that's changed.
