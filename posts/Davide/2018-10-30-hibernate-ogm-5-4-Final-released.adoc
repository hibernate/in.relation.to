...
* Infinispan remote https://docs.hibernate.org/ogm/5.4/reference/en-US/html_single/#infinispan-remote-transaction[transactions over HotRod] client
* https://docs.hibernate.org/ogm/5.4/reference/en-US/html_single/#_remote_query_capabilities[JPQL and native queries] support for Infinispan remote
* https://docs.hibernate.org/ogm/5.4/reference/en-US/html_single/#_infinispan_remote_stored_procedures[server side procedures calls] for Infinispan Remote
* Cache creation and configuration for https://docs.hibernate.org/ogm/5.4/reference/en-US/html_single/#infinispan-remote-cache-configuration[Infinispan remote]
* Java types `java.time.LocalDate`, `java.time.LocalDateTime` and `java.time.LocalTime` are natively supported as field types
* https://docs.hibernate.org/ogm/5.4/reference/en-US/html_single/#mongodb-gridfs-support[GridFS support for MongoDB]
