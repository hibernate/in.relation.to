...
http://docs.hibernate.org/ogm/5.0/reference/en-US/html_single/#ogm-redis-configuration[configuration options for Redis] in Hibernate OGM.
...
http://docs.hibernate.org/ogm/5.0/reference/en-US/html/ch11.html#ogm-mongodb-queries-native[support of native MongoDB queries].
