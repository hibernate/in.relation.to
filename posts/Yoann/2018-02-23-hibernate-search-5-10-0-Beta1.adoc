...
See the https://docs.hibernate.org/search/5.10/reference/en-US/html_single/#mapping-tika-bridge[TikaBridge documentation]
for more information.

For a full list of changes since 5.9.0.Final,
please see https://hibernate.atlassian.net/issues/?jql=project=10061+AND+fixVersion=31636[the release notes].
