...
in the link:https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-indexing-massindexer-parameters[MassIndexer documentation].
...
See link:https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#search-dsl-query-entity-loading-options[this section of the documentation]
...
see link:https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-indexing-merge-segments[this section of the documentation].
...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#backend-elasticsearch-field-types-available[here for Elasticsearch]
and https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#backend-lucene-field-types-available[here for Lucene].
* https://hibernate.atlassian.net/browse/HSEARCH-3793[HSEARCH-3793]:
The section of the documentation about the link:https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#search-dsl-predicate-exists[`exists` predicate]
...
please see the https://hibernate.atlassian.net/issues/?jql=project=10061+AND+fixVersion=31820[release notes].
