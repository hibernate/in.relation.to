...
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-indexing-explicit-writeplan-process-execute[the section of the documentation about explicit indexing].
...
See the https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#concepts-sharding-routing[section of the documentation about sharding]
