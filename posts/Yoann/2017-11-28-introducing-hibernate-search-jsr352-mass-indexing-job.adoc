...
Within Wildfly 11, https://docs.hibernate.org/stable/search/reference/en-US/html_single/#search-configuration-deploy-on-wildfly[use our JBoss modules],
...
* `.restrictedBy(String)`: use HQL to only index a subset of entities.
  ...
  See https://docs.hibernate.org/search/5.9/reference/en-US/html_single/#jsr-352-indexing-mode[the documentation] for details.
...
in https://docs.hibernate.org/search/5.9/reference/en-US/html_single/#jsr352-integration[the documentation].
...
as explained in https://docs.hibernate.org/search/5.9/reference/en-US/html_single/#jsr352-integration[the documentation].
