...
* https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-bridge-valuebridge-builtin[Indexable types]
* https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-bridge-identifierbridge-builtin[Document ID types]
...
see https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#configuration[here])
...
see https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-legacy-date-time-apis[here]).
