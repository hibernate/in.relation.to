 ...
 * https://hibernate.atlassian.net/browse/HSEARCH-2208[HSEARCH-2208]: use of `org.apache.lucene.search.Filter`
   ...
   See the https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#query-filter[updated documentation]
 ...
 * https://hibernate.atlassian.net/browse/HSEARCH-2502[HSEARCH-2502]: the worker can now be set to execute works asynchronously
   ...
   https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#configuration-worker[same `*.worker.execution` configuration option]
