...
For a full list of changes since 5.8.0.Beta1, please see https://hibernate.atlassian.net/issues/?jql=project=10061%20AND%20fixVersion=29000[the release notes].
