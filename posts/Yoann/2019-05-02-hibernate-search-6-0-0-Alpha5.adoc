...
(integer, date, etc.).
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-directfieldmapping-indexnullas[the documentation]
...
please see the https://hibernate.atlassian.net/issues/?jql=project=10061+AND+fixVersion=31769[release notes].
