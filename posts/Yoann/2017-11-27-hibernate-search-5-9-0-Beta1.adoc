 ...
 * https://hibernate.atlassian.net/browse/HSEARCH-2832[HSEARCH-2832]:
   ...
   https://docs.hibernate.org/search/5.9/reference/en-US/html_single/#elasticsearch-logging[as explained in the documentation].
...
please see https://hibernate.atlassian.net/issues/?jql=project=10061+AND+fixVersion=31616[the release notes].
