 ...
 * https://hibernate.atlassian.net/browse/HSEARCH-2734[HSEARCH-2734]: due to a lot of confusion and incorrect (harmful) use,
   ...
   read about https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#directory-provider-table[its limitations in the reference documentation],
 ...
 * https://hibernate.atlassian.net/browse/HSEARCH-2735[HSEARCH-2735]: index-time boosting features (`@Boost`, `@DynamicBoost`)
   ...
   See https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#section-boost-annotation[the reference documentation for alternatives]:
