...
please see the https://hibernate.atlassian.net/issues/?jql=project=10061%20AND%20fixVersion=31747[release notes].
...
For a full list of changes since the previous releases,
please see the https://hibernate.atlassian.net/issues/?jql=project=10061%20AND%20fixVersion=31732[release notes].
