...
:hsearchDocUrl: https://docs.hibernate.org/search/6.0/reference/en-US/html_single/
...
https://hibernate.org/search/[Hibernate Search] is a Java library that augments traditional ORM-based applications
with advanced search features, including in particular full-text search.
It integrates into https://hibernate.org/orm/[Hibernate ORM]
...
https://hibernate.org/orm/[Hibernate ORM] to handle persistence to a database,
and https://hibernate.org/search/[Hibernate Search] to add full-text search features to the application.
