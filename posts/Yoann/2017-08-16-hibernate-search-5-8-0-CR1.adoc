 ...
 * https://hibernate.atlassian.net/browse/HSEARCH-2831[HSEARCH-2831]:
  ...
  https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#elasticsearch-integration-configuration-aws[now requires you to set the `hibernate.search.default.elasticsearch.aws.signing.enabled` property to `true`],
 ...
 ** Mass indexing will now add documents in parallel, allowing you to take advantage
   ...
   Note you can
   https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#elasticsearch-integration-configuration[customize the maximum number of connections]
 ...
 * https://hibernate.atlassian.net/browse/HSEARCH-2840[HSEARCH-2840]: when using a metadata-providing
  ...
  https://docs.hibernate.org/search/5.8/reference/en-US/html_single/#elasticsearch-custom-field-bridge-dynamic-mapping[dynamic fields].
...
For a full list of changes since 5.8.0.Beta4, please see https://hibernate.atlassian.net/issues/?jql=project=10061+AND+fixVersion=30102[the release notes].
