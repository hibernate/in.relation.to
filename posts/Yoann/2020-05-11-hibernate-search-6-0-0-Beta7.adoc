...
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#search-dsl-sort-common-filter[here for sorts]
and
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#search-dsl-aggregation-common-filter[here for aggregations].
...
see https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-bridge-index-field-dsl-dynamic[this section of the reference documentation]
...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-mapping-inspect[this section of the reference documentation]
for more information.
...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#backend-lucene-io-writer[here for index writer settings]
and https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#backend-lucene-io-merge[here for merge settings].
...
can be
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#backend-lucene-analysis-similarity[configured through the `LuceneAnalysisConfigurer`].
