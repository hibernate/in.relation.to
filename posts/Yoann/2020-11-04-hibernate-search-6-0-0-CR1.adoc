...
:hsearch-migration-url-prefix: https://docs.hibernate.org/search/6.0/migration/html_single/
:hsearch-javadoc-url-prefix: https://docs.hibernate.org/search/6.0/api/
