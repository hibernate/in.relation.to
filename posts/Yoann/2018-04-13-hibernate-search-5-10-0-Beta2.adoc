...
https://docs.hibernate.org/search/5.10/reference/en-US/html_single/#section-bridge-dependency-injection[properly documented].

For a full list of changes since 5.10.0.Beta1,
please see https://hibernate.atlassian.net/issues/?jql=project=10061+AND+fixVersion=31627[the release notes].
