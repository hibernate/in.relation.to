...
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#getting-started[getting started guide]
...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-schema-management-strategy[automatic schema management]
...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-schema-management-manager[manual schema management]
for more information.
...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-indexing-massindexer-parameters[MassIndexer parameters] for more information.
...
* https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#backend-elasticsearch-configuration-version[Configure the expected version]
...
* Disable https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-schema-management-strategy[automatic schema management on startup]
by setting the property `hibernate.search.schema_management.strategy` to `none`.
* If necessary, add https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-schema-management-manager[explicit schema management]
...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#search-dsl-sort-common-multi-value-mode[this section of the documentation]
for more information.
...
the https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#search-dsl-predicate-simple-query-string[simple query string predicate] can now be configured to enable or disable syntax features as needed:
...
(https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#backend-lucene-threads[Lucene],
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#backend-elasticsearch-threads[Elasticsearch])
and the queues
(https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#backend-lucene-indexing-queues[Lucene],
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#backend-elasticsearch-indexing-queues[Elasticsearch]).
...
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-schema-management-strategy[the new `schema_management` options]
at the mapper level.
...
* https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#search-dsl-sort-common-order[Sort order]
* https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#search-dsl-sort-common-missing[Behavior on missing values]
...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#configuration-builder[this section of the documentation]
for more information.
...
please see the https://hibernate.atlassian.net/issues/?jql=project=10061+AND+fixVersion=31833[release notes].
