...
about https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-directfieldmapping-annotations-scalednumberfield[@ScaledNumberField].
...
about https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-indexing-automatic[automatic indexing].
...
please see the https://hibernate.atlassian.net/issues/?jql=project=10061+AND+fixVersion=31771[release notes].
