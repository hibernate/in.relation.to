...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#backend-elasticsearch-configuration-aws[the dedicated section in the documentation]
...
See the https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#configuration[section about configuration in the reference documentation]
