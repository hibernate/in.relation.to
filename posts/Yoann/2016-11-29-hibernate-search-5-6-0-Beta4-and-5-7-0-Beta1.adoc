 ...
 * ... and much more. The full change log can be found on https://hibernate.atlassian.net/issues/?jql=project=10061%20AND%20fixVersion=25250[our JIRA instance] or on https://github.com/hibernate/hibernate-search/blob/5.6.0.Beta4/changelog.txt[our GitHub repository].
