...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#_entity_graph[this section of the documentation]
...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-entityindexmapping[this section of the documentation]
for more information.
