...
with the exception of https://docs.hibernate.org/search/5.11/reference/en-US/html_single/#_restricting_query_results["drill-down"],
...
Core concepts:
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#concepts-full-text[full-text search],
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#concepts-mapping[mapping]
and
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#concepts-analysis[analysis]
...
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-bridge#mapper-orm-mapping[Mapping Hibernate ORM entities to indexes],
especially https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-indexedembedded[`@IndexedEmbedded`],
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-containerextractor[container extraction]
and https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-reindexing[tuning automatic reindexing].
* https://hibernate.atlassian.net/browse/HSEARCH-3692[HSEARCH-3692]:
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-bridge[Custom bridges]
* https://hibernate.atlassian.net/browse/HSEARCH-3615[HSEARCH-3615]:
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#search-dsl-query[Query DSL]
* https://hibernate.atlassian.net/browse/HSEARCH-3681[HSEARCH-3681]:
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-indexing-massindexer[MassIndexer]
