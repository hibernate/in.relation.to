...
:hsearch-doc-url-prefix: https://docs.hibernate.org/search/6.0/reference/en-US/html_single/
...
has moved to https://docs.hibernate.org/search/6.0/internals/html_single/.
