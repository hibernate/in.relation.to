...
and a complete documentation for all currently implemented features.
...
Projectable fields in with the Elasticsearch backend are no longer marked as `stored = true` in the generated mapping.
