...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#search-dsl-query-elasticsearch-json[this section of the documentation]
...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#search-dsl-aggregation-extensions-elasticsearch-from-json[this section of the documentation]
for examples.
...
see https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-bridge[the dedicated section in the reference documentation].
...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#search-dsl-query-timeout[the dedicated section in the reference documentation]
for more information.
...
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#backend-lucene-field-types-extension[here for Lucene]
and https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#backend-elasticsearch-field-types-extension[here for Elasticsearch].
...
please see the https://hibernate.atlassian.net/issues/?jql=project=10061+AND+fixVersion=31807[release notes].
