...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#configuration-background-failure-handling[this paragraph]
of the documentation for more information about search analyzers,
and https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#concepts-analysis[the "analysis" section]
...
See https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#configuration-background-failure-handling[the dedicated section in the documentation]
...
https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-indexing-automatic-synchronization[synchronization strategy]
(see that section of the documentation for details).
* failures of https://docs.hibernate.org/search/6.0/reference/en-US/html_single/#mapper-orm-indexing-manual[explicit indexing operations].
